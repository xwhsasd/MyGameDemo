...
public class Enemy_DeathBringer : Enemy
{
    ...
    public bool playerArriveGate = false;
    ...
    public virtual bool IsHeadDetected() => Physics2D.Raycast(headCheck.position, Vector2.right * facingDir, wallCheckDistance, whatIsGround);
